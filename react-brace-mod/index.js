...
import {editorEvents, editorOptions} from "./editorOptions.js";
...
export default class ReactAce extends Component {
    ...
    componentDidMount() {
        ...
        this.editor.on("linkHover", (data) => {
            let el = this.editor.container.getElementsByClassName('ace_content');
    ...
    render() {
        return (
            <div ref={this.updateRef}
                 id={name} className={this.props.className}
            >
            </div>
        );
    }
